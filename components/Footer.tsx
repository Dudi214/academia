        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="col-span-1 md:cols-span-2 ">
                    ...
                    <p className="mb-6 leading-relaxed max-w-md">Transform your life with our comprehensive fitness programs,expert trainers,and supportive community.</p>
            ...
            <p>
                &copy; {new Date().getFullYear()} FitPro Fitness. All rights reserved. Transform your body, transform your life.
            </p>
