                     ...
                     key={program.title} className="group cursor-pointer">
                        ...
                        <Card className="p-0 transition-shadow duration-300 hover:shadow-2xl">
                            ...
                            <CardContent className="p-6 pt-0">
                                ...
                                className="text-lg font-semibold font-heading text-foreground mb-3 group-hover:text-primary transition-colors">{program.title}</motion.h3>
                                ...
                                <motion.p
                                 ...
                                 className="text-muted-foreground mb-4 leading-relaxed">{program.description}
                                </motion.p>
